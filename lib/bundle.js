...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@apollo/client/core'), require('hash.js/lib/hash/sha/256'), require('graphql/language/printer')) :
	typeof define === 'function' && define.amd ? define(['exports', '@apollo/client/core', 'hash.js/lib/hash/sha/256', 'graphql/language/printer'], factory) :
	(factory((global.persistedQueryLink = {}),global._apollo_client_core,global.sha256,global.graphql_language_printer));
}(this, (function (exports,_apollo_client_core,sha256,graphql_language_printer) { 'use strict';
...
var createPersistedQueryLink = function (options) {
    ...
    return new _apollo_client_core.ApolloLink(function (operation, forward) {
        if (!forward) {
        ...
        return new _apollo_client_core.Observable(function (observer) {
            if (hashError) {
...
},{"@apollo/client/core":2,"graphql/language/printer":2,"hash.js/lib/hash/sha/256":2}],2:[function(require,module,exports){
