      ...
      function(require, module, exports) {
        (function(global, factory) {
          typeof exports === 'object' && typeof module !== 'undefined'
            ? factory(exports, require('@apollo/client/core'), require('graphql/language/printer'))
            : typeof define === 'function' && define.amd
            ? define(['exports', '@apollo/client/core', 'graphql/language/printer'], factory)
            : factory((global.persistedQueryLink = {}), global._apollo_client_core, global.graphql_language_printer);
        })(this, function(exports, _apollo_client_core, graphql_language_printer) {
          'use strict';
              ...
              return new _apollo_client_core.Observable(function(observer) {
                ...
                var handler = {
                  next: function(response) {
                    retry({ response: response }, function() {
                      return observer.next(response);
                    });
                  },
                  error: function(networkError) {
                    retry({ networkError: networkError }, function() {
